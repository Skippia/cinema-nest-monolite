...
describe('helpers for SeatOnCinema service', () => {
  ...
  /**
   * generateSeatSchema function
   */
  it('should generate seat schema', () => {
    const x = generateSeatSchema(seatsSchemaInput1)
    const y = generateSeatSchema(seatsSchemaInput2)
    const z = generateSeatSchema(seatsSchemaInput3)
