...
-- CreateEnum
CREATE TYPE "HallTypeEnum" AS ENUM ('1D', '2D', '3D', '4D', '5D');
...
CREATE TABLE "CinemaHall" (
    ...
    "hallType" "HallTypeEnum" NOT NULL DEFAULT '2D',
...
-- CreateTable
CREATE TABLE "SeatOnCinemaHall" (
    "seatId" INTEGER NOT NULL,
    "typeSeatId" INTEGER NOT NULL,
    "cinemaHallId" INTEGER NOT NULL,

    CONSTRAINT "SeatOnCinemaHall_pkey" PRIMARY KEY ("seatId","cinemaHallId")
);
...
-- AddForeignKey
ALTER TABLE "MovieSession" ADD CONSTRAINT "MovieSession_cinemaHallId_fkey" FOREIGN KEY ("cinemaHallId") REFERENCES "CinemaHall"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SeatOnCinemaHall" ADD CONSTRAINT "SeatOnCinemaHall_seatId_fkey" FOREIGN KEY ("seatId") REFERENCES "Seat"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SeatOnCinemaHall" ADD CONSTRAINT "SeatOnCinemaHall_typeSeatId_fkey" FOREIGN KEY ("typeSeatId") REFERENCES "TypeSeat"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SeatOnCinemaHall" ADD CONSTRAINT "SeatOnCinemaHall_cinemaHallId_fkey" FOREIGN KEY ("cinemaHallId") REFERENCES "CinemaHall"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
